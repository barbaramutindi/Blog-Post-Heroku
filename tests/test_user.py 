...
def setUp(self):
        ...
        admin = User(author="admin", password="admin2018", is_admin=True)

        # create test non-admin user
        hustler = User(author="test_user", password="test2016")
...
class CommentsModelTest(unittest.TestCase):
    ...
    def setUp(self):
       self.new_comment = Comments(id=1, user_id = 2, comment = 'cross buns',blogs_id = '5',date_posted='2018-09-09')
